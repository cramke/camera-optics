...
fn main() {
    ...
    match cli.command {
        ...
        Commands::Compare { distance, presets } => {
            let cameras = if presets {
                vec![
                    CameraSystem::new(36.0, 24.0, 6000, 4000, 50.0)
                        .with_name("Full Frame - 50mm"),
                    CameraSystem::new(23.5, 15.6, 6000, 4000, 35.0)
                        .with_name("APS-C - 35mm"),
                    CameraSystem::new(17.3, 13.0, 5184, 3888, 25.0)
                        .with_name("Micro 4/3 - 25mm"),
                ]
            } else {
            ...
            println!("Comparing camera systems at {} mm ({} m) distance:\n", distance, distance / 1000.0);
